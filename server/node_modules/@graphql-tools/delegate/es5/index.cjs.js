...
function mergeProxiedResults(target) {
    ...
    result[FIELD_SUBSCHEMA_MAP_SYMBOL] = target[FIELD_SUBSCHEMA_MAP_SYMBOL]
        ...
        : fieldSubschemaMap;
    var errors = sources.map(function (source) { return (source instanceof Error ? source : source[utils.ERROR_SYMBOL]); });
...
function handleObject(type, object, errors, subschema, context, info, skipTypeMerging) {
    ...
    var typeName = graphql.isAbstractType(type) ? info.schema.getTypeMap()[object.__typename].name : type.name;
