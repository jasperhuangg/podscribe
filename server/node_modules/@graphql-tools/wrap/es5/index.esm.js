...
var HoistField = /** @class */ (function () {
    function HoistField(typeName, path, newFieldName, alias) {
        ...
        this.transformer = new MapFields((_a = {},
            _a[typeName] = (_b = {},
                _b[newFieldName] = function (fieldNode) { return wrapFieldNode(renameFieldNode(fieldNode, oldFieldName), pathToField, alias); },
                _b),
            _a), (_c = {},
    ...
    HoistField.prototype.transformSchema = function (schema) {
        var _a;
        var _this = this;
        var innerType = this.pathToField.reduce(function (acc, pathSegment) { return getNullableType(acc.getFields()[pathSegment].type); }, schema.getType(this.typeName));
